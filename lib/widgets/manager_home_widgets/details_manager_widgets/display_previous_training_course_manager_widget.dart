...
class DisplayPreviousTrainingCourseManagerWidget extends StatelessWidget {
  final List<PreviousTrainingCourses> previousTrainingCourses;

  DisplayPreviousTrainingCourseManagerWidget({required this.previousTrainingCourses});
  ...
  Widget _buildPreviousTrainingCourseItem(BuildContext context, PreviousTrainingCourses course) {
    return Container(
