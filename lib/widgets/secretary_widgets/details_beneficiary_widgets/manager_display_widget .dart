  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: disabilities
          .map((disability) => _buildDisabilityItem(context, disability))
          .toList(),
    );
  }
  ...
  Widget _buildDisabilityItem(BuildContext context, Disability disability) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(disability.nameDisability ?? '',
              style: TextStyle(fontSize: 16, color: ColorManager.bc4)),
          if (disability.rateDisability != null)
            Text('Rate: ${disability.rateDisability}',
                style: TextStyle(fontSize: 16, color: ColorManager.bc4)),
        ],
      ),
    );
