...
import '../../Bloc/auth/stafflogin_state.dart';
...
class StaffLoginScreen extends StatelessWidget {
  ...
  static const id = 'StaffLoginScreen';

  @override
  Widget build(BuildContext context) {
    return const StaffLoginForm();
  }
}

class StaffLoginForm extends StatefulWidget {
  const StaffLoginForm({super.key});
...
class _StaffLoginFormState extends State<StaffLoginForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocListener<StaffLoginCubit, StaffLoginState>(
        listener: (context, state) {
          if (state is StaffLoginSuccess) {
            Navigator.pushReplacementNamed(context, '/secretary_home');
