class ExpiringSoonItemsModel {
  ExpiringSoonItemsModel({
    required this.currentPage,
    required this.dataExpiring,
  ...
  late final List<DataExpiring>? dataExpiring;
  ...
  ExpiringSoonItemsModel.fromJson(Map<String, dynamic> json){
    currentPage = json['current_page'];
    dataExpiring = List.from(json['data']).map((e)=>DataExpiring.fromJson(e)).toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['data'] = dataExpiring!.map((e)=>e.toJson()).toList();
...
class DataExpiring {
  ...
  DataExpiring.fromJson(Map<String, dynamic> json){
    id = json['id'];
    name = json['name'];
