...
class _PendingCourseScreenState extends State<PendingCourseScreen> {
  ...
  void _fetchPendingRequests() {
    context.read<PendingRequestCubit>().fetchPendingRequests().then((_) {
      if (mounted) {
        setState(() {});
      }
    });
              ...
              child: Column(
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Please enter the course status';
                      }
                      return null;
                    },
                    onSaved: (value) {
            ...
            TextButton(
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  await context.read<CourseCubit>().addCourse(newCourse);
                  if (mounted) {
                    Navigator.of(context).pop();
                    _fetchPendingRequests();
                  }
  ...
  Widget build(BuildContext context) {
    return BlocListener<CourseCubit, CourseState>(
      listener: (context, state) {
        if (state is CourseLoaded && mounted) {
          _fetchPendingRequests();
        }
      },
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  Text('Period: ${course.coursePeriod}',
                                      style:
