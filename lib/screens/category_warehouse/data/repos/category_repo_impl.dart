...
class CategoryRepoImpl implements CategoryRepo {
  ...
  @override
  Future<Either<Failure, List<AllRequestCategoryModel>>> fetchRequestCategories() async {
    try {
      var data = await (dioApiService.get(
      ...
      log(data.toString());
      List<AllRequestCategoryModel> allRequestCategoryModel = [];
      for (var item in data) {
        allRequestCategoryModel.add(AllRequestCategoryModel.fromJson(item));
      }
  ...
  @override
  Future<Either<Failure, List<AllRequestItemModel>>> fetchRequestItems() async {
    try {
      var data = await (dioApiService.get(
      ...
      log(data.toString());
      List<AllRequestItemModel> allRequestItemModel = [];
      for (var item in data) {
        allRequestItemModel.add(AllRequestItemModel.fromJson(item));
      }
